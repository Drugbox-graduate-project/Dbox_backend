...
public class DrugboxController {
    ...
    public ResponseEntity<IdResponse> inviteUserToDrugbox(@RequestParam(value="drugboxId") Long drugboxId,
                                                    @RequestParam(value="nickname") String nickname){
        Long invitationId = drugboxService.inviteUserToDrugbox(drugboxId, nickname);
        IdResponse response = IdResponse.builder()
                .id(invitationId)
                .build();
        return ResponseEntity.ok(response);
    ...
    public ResponseEntity<Void> acceptInvitation(@RequestParam(value="invitationId") Long invitationId){
        drugboxService.acceptInvitation(invitationId, SecurityUtil.getCurrentUserId());
        return new ResponseEntity(HttpStatus.OK);
    }
}
